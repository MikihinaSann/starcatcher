...
)
{
    ...
    public static final StreamCodec<FishCaughtCounter> STREAM_CODEC = ExtraComposites.composite(
            StreamCodec.INT, FishCaughtCounter::count,
            StreamCodec.INT, FishCaughtCounter::fastestTicks,
            StreamCodec.FLOAT, FishCaughtCounter::averageTicks,
            StreamCodec.INT, FishCaughtCounter::size,
            StreamCodec.INT, FishCaughtCounter::weight,
            StreamCodec.LONG, FishCaughtCounter::firstCatch,
            StreamCodec.BOOL, FishCaughtCounter::caughtGolden,
            StreamCodec.BOOL, FishCaughtCounter::perfectCatch,
            StreamCodec.BOOL, FishCaughtCounter::hasGuideNotification,
